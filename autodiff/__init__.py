...
from autodiff.autodiff.core import register_graph, set_parameters, backward_prop, zero_grad, set_forwarded

# export the gradient-related function
from autodiff.autodiff.diff import *
globals().update(np.__dict__)

for func in [register_graph, set_parameters, backward_prop, zero_grad, set_forwarded]:
